...
export class TalkingStickiesApplet extends ScopedElementsMixin(LitElement) {
  @property()
  ...
  async firstUpdated() {
    ...
    //
    // eg:
    // new ContextProvider(this, talking_stickiesContext, new TalkingStickiesStore(cellClient, store));
